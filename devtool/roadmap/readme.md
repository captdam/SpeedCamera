...
![Satellite](docs/satellite.jpg "Tatellite")
...
- Avoid run-time computation-intense operation such as trigonometry, which saves GPU time and increases performance. 
